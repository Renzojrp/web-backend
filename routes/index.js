...
api.get('/instrument/musician/:musicianId', instrumentControllers.getInstrumentbyMusician)
...
api.get('/publication/user/:musicianId', publicationControllers.getPublicationbyMusician)
api.get('/publication/state/:status', publicationControllers.getPublicationbyStatus)
